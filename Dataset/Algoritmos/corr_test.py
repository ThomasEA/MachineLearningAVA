# -*- coding: utf-8 -*-
"""
Created on Sat Oct 21 05:50:38 2017

@author: Everton

Fazer testes de correlação entre variáveis
...
#features = ['Login_Quantidade','Turno_TempoUsoTotal_Somado','Log_Post_Quantidade_Somado','Evadido']
features = ['Turno_TempoUsoTarde_Somado','Turno_TempoUsoTotal_Somado','Log_Post_Quantidade_Somado','Evadido']
#-------------------------------------------------------
...
df_s.to_csv('coral_source.csv', index=False)
df_t.to_csv('original_test.csv', index=False)


fig = plt.figure()#(figsize=(16,16))
ax = fig.add_subplot(111, projection='3d')

x_s =df_s.Turno_TempoUsoTarde_Somado
y_s =df_s.Log_Post_Quantidade_Somado
z_s =df_s.Turno_TempoUsoTotal_Somado

ax.scatter(x_s, y_s, z_s, c='r', marker='o')

x_t =df_t.Turno_TempoUsoTarde_Somado
